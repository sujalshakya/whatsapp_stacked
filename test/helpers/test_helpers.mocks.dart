...
import 'package:whatsapp_stacked/base/models/user.dart' as _i12;
import 'package:whatsapp_stacked/services/fetch_user_service.dart' as _i11;
import 'package:whatsapp_stacked/services/firebase_auth_service.dart' as _i21;
...
class MockRegisterService extends _i1.Mock implements _i9.RegisterService {
  @override
  _i6.Future<String> registerFirebase(
    String? email,
    String? password,
  ) =>
      (super.noSuchMethod(
...
class MockFetchUserService extends _i1.Mock implements _i11.FetchUserService {
  @override
  _i6.Future<List<_i12.User>> fetchUsers() => (super.noSuchMethod(
        Invocation.method(
          #fetchUsers,
          [],
        ),
        returnValue: _i6.Future<List<_i12.User>>.value(<_i12.User>[]),
        returnValueForMissingStub:
            _i6.Future<List<_i12.User>>.value(<_i12.User>[]),
      ) as _i6.Future<List<_i12.User>>);
}
...
class MockFetchMessagesService extends _i1.Mock
  ...
  @override
  _i6.Future<List<_i16.Messages>> fetchMessages(String? uid) =>
      (super.noSuchMethod(
        Invocation.method(
          #fetchMessages,
          [uid],
        ),
        returnValue: _i6.Future<List<_i16.Messages>>.value(<_i16.Messages>[]),
        returnValueForMissingStub:
            _i6.Future<List<_i16.Messages>>.value(<_i16.Messages>[]),
      ) as _i6.Future<List<_i16.Messages>>);
}
...
class MockOtherMessagesRepositoryImpService extends _i1.Mock
  ...
  @override
  _i6.Future<List<_i16.Messages>> fetchMessagesThroughRepo(String? uid) =>
      (super.noSuchMethod(
        Invocation.method(
          #fetchMessagesThroughRepo,
          [uid],
        ),
        returnValue: _i6.Future<List<_i16.Messages>>.value(<_i16.Messages>[]),
        returnValueForMissingStub:
...
class MockFirebaseAuthService extends _i1.Mock
    implements _i21.FirebaseAuthService {}
